...
whether the \attr{global-declarations} option is set to \ter{true} or not.
...
%%% declare-fun %%%
%
\item[\expr{(declare-fun $f$ ($\sigma_1$ $\cdots$ $\sigma_n$) $\sigma$)}]
...
%%% declare-const %%%
%
\item[\expr{(declare-const $f$ $\sigma$)}]
abbreviates the command \expr{(declare-fun $f$ () $\sigma$)}.
\smallskip
...
%-------------------------------------------------------------------------------
\subsection{Asserting and inspecting formulas}
%-------------------------------------------------------------------------------
...
%
\item[\expr{(assert $t$)}]
where $t$ is a well-sorted formula (i.e., a well-sorted term of sort \ter{Bool}),
