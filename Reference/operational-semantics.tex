...
\new{
In SMT-LIB 2.7, hte \expr{par} construct, short for \emph{parameter}, is a misnomer,
...
\endnote{
\new{
Using sort variables as opposed to globally declared sort parameters
...
Consider the negation of this assertions.  It should state that at least one sort has a
