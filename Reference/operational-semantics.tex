...
\end{lstlisting}
In the first case, the second command assert that \emph{all sorts} constructible with the available sort constructors have a singleton domain.  In the second case though, the assertion restricts only sort \ter{U} to have a singleton domain.
\end{remark}
