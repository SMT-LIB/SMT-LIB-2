...
\endnote{Using sort variables as opposed to globally declared sort parameter
is necessary because their order is meaningful.}
...
\new{Any sort term occurring in $t$ may be polymorphic, i.e., it may contain
previously declared sort parameters.}
...
\pfrem{There is something to check about the very notion of polymorphism.
Check the comments in the tex file.}
...
% CN+CT+PF: it seems the only case that makes sense is the first one.
% Need to clarify the meaning of define-const/-fun in the context of polymorphism
