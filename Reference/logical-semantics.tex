...
where Case~\ref{ruleI} is the only rule applying to terms containing sort parameters, whereas the other rules only apply to terms without sort parameters.
...
\begin{cases}
 ...
 \Sigma \vdash t_i{:}\sigma_i\text{ for } i = 1,\dots, n,\\
 \text{and }f {:} \sigma_1\cdots\sigma_n\sigma \in \Sigma
\end{cases}
\)
...
\begin{cases}
 ...
 \Sigma \vdash t_i{:}\sigma_i \text{ and }a_i = \mea{\inter I}{t_i}\text{ for } i=1,\ldots,n ,\\
%\quad \Sigma \vdash t_i : \sigma_i \text{ and } a_i = \mea{\inter I}{t_i}, \\
