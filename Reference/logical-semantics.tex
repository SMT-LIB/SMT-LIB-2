...
\begin{figure}
\terms
\caption{Abstract syntax for unsorted terms\\\pfrem{We must extend this with PTerms, as in concrete syntax}}
...
\pfrem{We need to introduce lambdas, and pterms}
