...
\new{and  monographs of higher-order logic~\cite{andrews86}\todo{add references}
% We should refer to this
%https://sourceforge.net/projects/hol/files/hol/trindemossen-1/trindemossen-1-logic.pdf/download?use_mirror=master&use_mirror=master&r=
% Here is a paper that refers to an older version https://ceur-ws.org/Vol-1955/staf-ds-2017-6.pdf
.}
...
This has the effect to allowing prenex (or rank-1) polymorphism in assertions 
...
Consistently with this extension, the command language is extended 
