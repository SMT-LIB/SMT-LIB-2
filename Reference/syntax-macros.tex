...
\begin{tabular}{ll}
  ...
  {\Sigma \vdash (\lambda x:\tau_1\; t_2): \tau_1 \to \tau_2}
  &
  \end{tabular}
  \bigskip
...
%% quantifiers
\begin{tabular}{ll}
\derives{\Sigma[x_1{:}\tau_1,\: \ldots,\: x_{k+1}{:}\tau_{k+1}]\: \vdash t:\bool}
{\Sigma \vdash (Q x_1{:}\tau_1\, \cdots\, x_{k+1}{:}\tau_{k+1}\; t)\ \alpha^* : \bool}
&
